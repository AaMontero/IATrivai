...
def mensaje_Llega(mensaje):
    conversa = {
        ...
        "Gracias por la informacion": ["Estamos para antenderte, si deseas otra cosa no dudes en informarme"],
        "Muchas gracias": None,
